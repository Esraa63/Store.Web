...
namespace Store.Repository.Repositories
{
    public class UnitOfWork : IUnitOfWork
    {
        ...
        public IGenericRepoistory<TEntity, TKey> Repoistory<TEntity, TKey>() where TEntity : BaseEntity<TKey>
        {
            ...
            {
                var repositoryType= typeof(GenericRepoistory<,>);
            ...
            return (IGenericRepoistory < TEntity, TKey> ) _repositories[entityKey];
        }
    }
}
